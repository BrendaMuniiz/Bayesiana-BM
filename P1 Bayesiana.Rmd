...
$−E[\frac{∂^2}{∂θ^2}\frac{(−log(2πσ^2)}{2} − \frac{1}{2σ^2}\sum_{i = 1}^{n}(y_i − θ)^2]= −E[\frac{∂^2}{∂θ^2}\frac{(−log(2πσ^2)}{2} − \frac{1}{2σ^2}\sum_{i = 1}^{n}(y_i^2 − 2θn\overline{y} + nθ^2)]= −E[\frac{∂}{∂θ} − (\frac{1}{2σ^2}(-2n\overline{y} + 2nθ))]= -E [\frac{1}{2σ^2}(2n)] = \frac{n}{σ^2}$
